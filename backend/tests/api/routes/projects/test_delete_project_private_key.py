...
class TestDeleteProjectPrivateKey(BaseTestCase):
    ...
    def test_delete_project_private_key__200(self) -> None:
        with utils.new_project(project=utils.Project()) as project:
            ...
            result = self.run_test_with_user(
                ...
                test_name='test_delete_project_private_key__200',
    ...
    def test_delete_project_private_key__403_read_only_role(self) -> None:
        with utils.new_project(project=utils.Project()) as project:
            with MySQLService.get_session() as session:
                project_private_key_id = session.scalar(
                    select(
            ...
            result = self.run_test_with_user(
                runner=self.runner,
                path_to_test_cases=self.path_to_test_cases,
                test_name='test_delete_project_private_key__403_read_only_role',
    ...
    def test_delete_project_private_key__403_project_not_assigned_to_user(self) -> None:
        with utils.new_project(project=utils.Project()) as project:
            with MySQLService.get_session() as session:
                project_private_key_id = session.scalar(
                    select(
            ...
            result = self.run_test_with_user(
                runner=self.runner,
                path_to_test_cases=self.path_to_test_cases,
                test_name='test_delete_project_private_key__403_project_not_assigned_to_user',
                user=utils.User(),
                url_params={
                    'project_id': project_id,
                    'project_private_key_id': project_private_key_id
    ...
    def test_delete_project_private_key__404(self) -> None:
        with utils.new_project(project=utils.Project()) as project:
            project_id = project.project_id
            result = self.run_test_with_user(
                runner=self.runner,
                path_to_test_cases=self.path_to_test_cases,
                test_name='test_delete_project_private_key__404',
                user=utils.User(projects=[project_id]),
