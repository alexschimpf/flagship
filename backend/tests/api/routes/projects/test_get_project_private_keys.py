...
class TestGetProjectPrivateKey(BaseTestCase):
    ...
    def test_get_project_private_keys__200(self) -> None:
        with utils.new_project(project=utils.Project()) as project:
            ...
            result = self.run_test_with_user(
                ...
                test_name='test_get_project_private_keys__200',
    ...
    def test_get_project_private_keys__403_read_only_role(self) -> None:
        with utils.new_project(project=utils.Project()) as project:
            project_id = project.project_id
            result = self.run_test_with_user(
                runner=self.runner,
    ...
    def test_get_project_private_keys__403_project_not_assigned_to_user(self) -> None:
        with utils.new_project(project=utils.Project()) as project:
            project_id = project.project_id
            result = self.run_test_with_user(
                runner=self.runner,
