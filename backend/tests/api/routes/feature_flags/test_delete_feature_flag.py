...
class TestDeleteFeatureFlag(BaseTestCase):
    ...
    def test_delete_feature_flag__403_project_not_assigned(self) -> None:
        with (
            utils.new_project(project=utils.Project()) as project,
            utils.new_feature_flag(
                project_id=project.project_id, feature_flag=utils.FeatureFlag()) as feature_flag,
            ...
            result = self.run_test_with_user(
                runner=self.runner,
                path_to_test_cases=self.path_to_test_cases,
                test_name='test_delete_feature_flag__403_project_not_assigned',
                user=utils.User(),
                url_params={
                    'project_id': project.project_id,
                    'feature_flag_id': feature_flag.feature_flag_id
    ...
    def test_delete_feature_flag__403_read_only_role(self) -> None:
        with (
            utils.new_project(project=utils.Project()) as project,
            utils.new_feature_flag(
                project_id=project.project_id, feature_flag=utils.FeatureFlag()) as feature_flag,
            ...
            result = self.run_test_with_user(
                runner=self.runner,
                path_to_test_cases=self.path_to_test_cases,
                test_name='test_delete_feature_flag__403_read_only_role',
