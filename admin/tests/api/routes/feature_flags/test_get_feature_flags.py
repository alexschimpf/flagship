...
class TestGetFeatureFlags(BaseTestCase):
    ...
    def test_get_feature_flags__200(self) -> None:
        with (
            ...
            utils.new_feature_flag(project_id=project1.project_id, feature_flag=utils.FeatureFlag()) as feature_flag1,
            utils.new_feature_flag(project_id=project2.project_id, feature_flag=utils.FeatureFlag()),
        ):
            result = self.run_test_with_user(
                ...
                url_params={'project_id': project1.project_id, 'feature_flag_id': feature_flag1.feature_flag_id},
