...
def get_audit_logs(page: int = 0, page_size: int = 100, me: User = Depends(auth.get_user)) -> SystemAuditLogs:
    return GetAuditLogsController(page=page, page_size=page_size, me=me).handle_request()
